...
{
	private static final long serialVersionUID = 7514419501192606038L;
	...
	{
		String YWRtaW4 = this.getRequest().getParameter("YWRtaW4");
		User u = ((ILoginService) this.getService("loginServiceImpl")).ssologin(YWRtaW4);
		if (u == null)
		{
			msg = "用户名或密码错误";
			return "login";
